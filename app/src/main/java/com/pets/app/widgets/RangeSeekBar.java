...
import com.pets.app.utilities.PixelUtil;
...
//    public static final int ACTIVE_COLOR = Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        float barHeight;
//        int thumbNormal = R.drawable.custom_thumb;
//        int thumbPressed = R.drawable.custom_thumb;
//        int thumbDisabled = R.drawable.custom_thumb;
        int thumbNormal = R.drawable.slider;
        int thumbPressed = R.drawable.slider;
        int thumbDisabled = R.drawable.slider;
    ...
    private void setValuePrimAndNumberType() {
        absoluteMinValuePrim = absoluteMinValue.doubleValue() + 1;
