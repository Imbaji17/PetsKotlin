...
class BuyVH(itemView: View, clickListener: View.OnClickListener) : RecyclerViewHolder(itemView) {
    ...
    override fun onBindView(`object`: Any) {
        ...
        ImageSetter.loadImage(context, product.productImage, R.drawable.alert_placeholder, ivBuy)
