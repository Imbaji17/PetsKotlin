...
public class WebServiceBuilder {
    ...
    public interface ApiClient {
        ...
        @GET("pet_sitter_details_by_id")
        Call<PetSitterResponse> petSitterDetailsById(@Query("user_id") String user_id, @Query("timestamp") String timestamp, @Query("key") String key, @Query("language_code") String language_code,
                                                   @Query("lat") String lat, @Query("lng") String lng, @Query("pet_sitter_id") String pet_sitter_id);
